DROP DATABASE IF EXISTS ecole_cascades;
CREATE DATABASE IF NOT EXISTS ecole_cascades;
USE ecole_cascades;
...
CREATE TABLE cours (
    ...
    FOREIGN KEY (enseignant) REFERENCES enseignants (code_employe) ON DELETE CASCADE
);
...
CREATE TABLE programmes (
    ...
    FOREIGN KEY (prof_responsable) REFERENCES enseignants (code_employe) ON DELETE CASCADE
);
...
CREATE TABLE etudiants (
    ...
    FOREIGN KEY (code_programme) REFERENCES programmes (code_programme) ON DELETE CASCADE
);
...
CREATE TABLE inscriptions (
    ...
    groupe_id INTEGER,
    FOREIGN KEY (code_etudiant) REFERENCES etudiants (code_etudiant) ON DELETE CASCADE,
